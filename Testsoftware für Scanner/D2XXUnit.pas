...
//*******************************************************************
//**   Info FTDI nicht in der D2XX.Pas enthalten selbst erstellt   **
//*******************************************************************
function FT_Relodet(Fvid:Dword;Fpid:Dword):FT_Result;
function FT_Deadman_Timeout(Timeout:Dword):FT_Result;
...
// DLL Name
    ...
    //Neu evant test warten auf char usw.
...
//**   Info FTDI nicht in der D2XX.Pas enthalten selbst erstellt   **
//*******************************************************************
function FT_Reload(vid: Dword; pid: Dword) : FT_Result; stdcall; External FT_DLL_Name name 'FT_Reload';
function FT_SetDeadmanTimeout(ftHandle:Dword; TimeOut:Dword):FT_Result; stdcall; External FT_DLL_Name name 'FT_SetDeadmanTimeout';
//*******************************************************************
//**   Info FTDI nicht in der D2XX.Pas enthalten selbst erstellt   **
//*******************************************************************
function FT_Relodet(Fvid:Dword;Fpid:Dword):FT_Result;
begin
  Result := FT_Reload(Fvid,Fpid);
end;

function FT_Deadman_Timeout(Timeout:Dword):FT_Result;
begin
  Result := FT_SetDeadmanTimeout(FT_Handle, TimeOut);
end;
