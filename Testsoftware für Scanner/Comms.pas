...
procedure TComPort.initcom1;
begin;
FFlowControl.ControlRts:=rtsDisable;
FLowControl.FOutCtsFlow:=true;
SetDCB;
FTimeouts.FReadInterval:= -1;
FTimeouts.FReadTotalM:=30;
FTimeouts.FReadTotalC:=30;
settimeouts;
end;

procedure TComPort.initcom2;
begin;
FFlowControl.ControlRts:=RTSenable;
FFlowControl.ControlDTR:=DTRenable;
FLowControl.FOutCtsFlow:=true;
SetDCB;
FTimeouts.FReadInterval:=-5;
FTimeouts.FReadTotalM:=5;
FTimeouts.FReadTotalC:=5;
settimeouts;
end;
